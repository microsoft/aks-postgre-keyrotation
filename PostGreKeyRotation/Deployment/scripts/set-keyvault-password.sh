...
existingBlueValue=$(az keyvault secret show --id https://jwrotatekeyvault.vault.azure.net/secrets/pgmainbluepwd --vault-name jwrotatekeyvault)
...
existingGreenValue=$(az keyvault secret show --id https://jwrotatekeyvault.vault.azure.net/secrets/pgmaingreenpwd --vault-name jwrotatekeyvault)
